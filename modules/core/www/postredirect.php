...
/// This area modified to post all data that coming from IDP and posted to SP
//  Default:  $template->data['destination'] = $postData['url'];

$template->data['destination'] = 'https//www.spdomain.com/saml/';
